DMAPP.Config = function (params) {
    ...
    var viewModel = {
        ...
        lookupServiceOption: {
            dataSource: [
                { SERVICE: "http://192.168.2.6/DMWebAPINew", DES: "南通正式库-新" },
                { SERVICE: "http://58.221.237.66:8005/DMWebAPINew", DES: "南通正式库-新（外网）" },
                { SERVICE: "http://192.168.2.6/DMWebAPINewTest", DES: "南通测试库-新" },
                { SERVICE: "http://58.221.237.66:8005/DMWebAPINewTest", DES: "南通测试库-新（外网）" },
                { SERVICE: "http://192.168.2.6/DMWebAPI", DES: "南通正式库-旧" },
                { SERVICE: "http://58.221.237.66:8005/DMWebAPI", DES: "南通正式库-旧（外网）" },
